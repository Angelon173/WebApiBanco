...
namespace WebApiBanco.Services
{
    public class EscribirEnArchivo : IHostedService
    {
        private readonly IWebHostEnvironment env;

        private readonly string nombreArchivo = "Autorizaciones.txt";
        ...
        {
            Escribir("Automatizando " + DateTime.Now.ToString("dd/MM/yyyy hh:mm:ss"));
